...
_POWERMON = DESCRIPTOR.message_types_by_name['PowerMon']
_POWERSTRESSMESSAGE = DESCRIPTOR.message_types_by_name['PowerStressMessage']
_POWERMON_STATE = _POWERMON.enum_types_by_name['State']
_POWERSTRESSMESSAGE_OPCODE = _POWERSTRESSMESSAGE.enum_types_by_name['Opcode']
PowerMon = _reflection.GeneratedProtocolMessageType('PowerMon', (_message.Message,), {
  'DESCRIPTOR' : _POWERMON,
  '__module__' : 'meshtastic.protobuf.powermon_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.PowerMon)
  })
_sym_db.RegisterMessage(PowerMon)

PowerStressMessage = _reflection.GeneratedProtocolMessageType('PowerStressMessage', (_message.Message,), {
  'DESCRIPTOR' : _POWERSTRESSMESSAGE,
  '__module__' : 'meshtastic.protobuf.powermon_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.PowerStressMessage)
  })
_sym_db.RegisterMessage(PowerStressMessage)
