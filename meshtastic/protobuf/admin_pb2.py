...
_OTAMODE = DESCRIPTOR.enum_types_by_name['OTAMode']
OTAMode = enum_type_wrapper.EnumTypeWrapper(_OTAMODE)
NO_REBOOT_OTA = 0
OTA_BLE = 1
OTA_WIFI = 2
...
_ADMINMESSAGE_INPUTEVENT = _ADMINMESSAGE.nested_types_by_name['InputEvent']
...
_SHAREDCONTACT = DESCRIPTOR.message_types_by_name['SharedContact']
_KEYVERIFICATIONADMIN = DESCRIPTOR.message_types_by_name['KeyVerificationAdmin']
...
_ADMINMESSAGE_BACKUPLOCATION = _ADMINMESSAGE.enum_types_by_name['BackupLocation']
_KEYVERIFICATIONADMIN_MESSAGETYPE = _KEYVERIFICATIONADMIN.enum_types_by_name['MessageType']
AdminMessage = _reflection.GeneratedProtocolMessageType('AdminMessage', (_message.Message,), {
  ...
  'InputEvent' : _reflection.GeneratedProtocolMessageType('InputEvent', (_message.Message,), {
    'DESCRIPTOR' : _ADMINMESSAGE_INPUTEVENT,
    '__module__' : 'meshtastic.protobuf.admin_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.AdminMessage.InputEvent)
    })
  ,
  'DESCRIPTOR' : _ADMINMESSAGE,
  '__module__' : 'meshtastic.protobuf.admin_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.AdminMessage)
  })
_sym_db.RegisterMessage(AdminMessage)
_sym_db.RegisterMessage(AdminMessage.InputEvent)

HamParameters = _reflection.GeneratedProtocolMessageType('HamParameters', (_message.Message,), {
  'DESCRIPTOR' : _HAMPARAMETERS,
  '__module__' : 'meshtastic.protobuf.admin_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.HamParameters)
  })
...
NodeRemoteHardwarePinsResponse = _reflection.GeneratedProtocolMessageType('NodeRemoteHardwarePinsResponse', (_message.Message,), {
  ...
  '__module__' : 'meshtastic.protobuf.admin_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.NodeRemoteHardwarePinsResponse)
  })
_sym_db.RegisterMessage(NodeRemoteHardwarePinsResponse)

SharedContact = _reflection.GeneratedProtocolMessageType('SharedContact', (_message.Message,), {
  'DESCRIPTOR' : _SHAREDCONTACT,
  '__module__' : 'meshtastic.protobuf.admin_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.SharedContact)
  })
_sym_db.RegisterMessage(SharedContact)

KeyVerificationAdmin = _reflection.GeneratedProtocolMessageType('KeyVerificationAdmin', (_message.Message,), {
  'DESCRIPTOR' : _KEYVERIFICATIONADMIN,
  '__module__' : 'meshtastic.protobuf.admin_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.KeyVerificationAdmin)
  })
_sym_db.RegisterMessage(KeyVerificationAdmin)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _OTAMODE._serialized_start=4337
  _OTAMODE._serialized_end=4392
  _ADMINMESSAGE._serialized_start=281
  _ADMINMESSAGE._serialized_end=3707
  _ADMINMESSAGE_INPUTEVENT._serialized_start=3033
  _ADMINMESSAGE_INPUTEVENT._serialized_end=3116
  _ADMINMESSAGE_CONFIGTYPE._serialized_start=3119
  _ADMINMESSAGE_CONFIGTYPE._serialized_end=3333
  _ADMINMESSAGE_MODULECONFIGTYPE._serialized_start=3336
  _ADMINMESSAGE_MODULECONFIGTYPE._serialized_end=3651
  _ADMINMESSAGE_BACKUPLOCATION._serialized_start=3653
  _ADMINMESSAGE_BACKUPLOCATION._serialized_end=3688
  _HAMPARAMETERS._serialized_start=3709
  _HAMPARAMETERS._serialized_end=3800
  _NODEREMOTEHARDWAREPINSRESPONSE._serialized_start=3802
  _NODEREMOTEHARDWAREPINSRESPONSE._serialized_end=3913
  _SHAREDCONTACT._serialized_start=3915
  _SHAREDCONTACT._serialized_end=4039
  _KEYVERIFICATIONADMIN._serialized_start=4042
  _KEYVERIFICATIONADMIN._serialized_end=4335
  _KEYVERIFICATIONADMIN_MESSAGETYPE._serialized_start=4212
  _KEYVERIFICATIONADMIN_MESSAGETYPE._serialized_end=4315
