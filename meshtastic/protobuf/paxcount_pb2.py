...
_PAXCOUNT = DESCRIPTOR.message_types_by_name['Paxcount']
Paxcount = _reflection.GeneratedProtocolMessageType('Paxcount', (_message.Message,), {
  'DESCRIPTOR' : _PAXCOUNT,
  '__module__' : 'meshtastic.protobuf.paxcount_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Paxcount)
  })
_sym_db.RegisterMessage(Paxcount)
