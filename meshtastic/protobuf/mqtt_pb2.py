...
_MAPREPORT = DESCRIPTOR.message_types_by_name['MapReport']
ServiceEnvelope = _reflection.GeneratedProtocolMessageType('ServiceEnvelope', (_message.Message,), {
  'DESCRIPTOR' : _SERVICEENVELOPE,
  '__module__' : 'meshtastic.protobuf.mqtt_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.ServiceEnvelope)
  })
_sym_db.RegisterMessage(ServiceEnvelope)

MapReport = _reflection.GeneratedProtocolMessageType('MapReport', (_message.Message,), {
  'DESCRIPTOR' : _MAPREPORT,
  '__module__' : 'meshtastic.protobuf.mqtt_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.MapReport)
  })
_sym_db.RegisterMessage(MapReport)
