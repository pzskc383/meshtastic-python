...
_COMPASSMODE = DESCRIPTOR.enum_types_by_name['CompassMode']
CompassMode = enum_type_wrapper.EnumTypeWrapper(_COMPASSMODE)
_THEME = DESCRIPTOR.enum_types_by_name['Theme']
...
_DEVICEUICONFIG = DESCRIPTOR.message_types_by_name['DeviceUIConfig']
_NODEFILTER = DESCRIPTOR.message_types_by_name['NodeFilter']
_NODEHIGHLIGHT = DESCRIPTOR.message_types_by_name['NodeHighlight']
_GEOPOINT = DESCRIPTOR.message_types_by_name['GeoPoint']
_MAP = DESCRIPTOR.message_types_by_name['Map']
_DEVICEUICONFIG_GPSCOORDINATEFORMAT = _DEVICEUICONFIG.enum_types_by_name['GpsCoordinateFormat']
DeviceUIConfig = _reflection.GeneratedProtocolMessageType('DeviceUIConfig', (_message.Message,), {
  'DESCRIPTOR' : _DEVICEUICONFIG,
  '__module__' : 'meshtastic.protobuf.device_ui_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.DeviceUIConfig)
  })
_sym_db.RegisterMessage(DeviceUIConfig)

NodeFilter = _reflection.GeneratedProtocolMessageType('NodeFilter', (_message.Message,), {
  'DESCRIPTOR' : _NODEFILTER,
  '__module__' : 'meshtastic.protobuf.device_ui_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.NodeFilter)
  })
_sym_db.RegisterMessage(NodeFilter)

NodeHighlight = _reflection.GeneratedProtocolMessageType('NodeHighlight', (_message.Message,), {
  'DESCRIPTOR' : _NODEHIGHLIGHT,
  '__module__' : 'meshtastic.protobuf.device_ui_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.NodeHighlight)
  })
_sym_db.RegisterMessage(NodeHighlight)

GeoPoint = _reflection.GeneratedProtocolMessageType('GeoPoint', (_message.Message,), {
  'DESCRIPTOR' : _GEOPOINT,
  '__module__' : 'meshtastic.protobuf.device_ui_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.GeoPoint)
  })
...
Map = _reflection.GeneratedProtocolMessageType('Map', (_message.Message,), {
  'DESCRIPTOR' : _MAP,
  '__module__' : 'meshtastic.protobuf.device_ui_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Map)
  })
