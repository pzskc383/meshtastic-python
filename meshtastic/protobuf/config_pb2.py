...
_CONFIG_SECURITYCONFIG = _CONFIG.nested_types_by_name['SecurityConfig']
_CONFIG_SESSIONKEYCONFIG = _CONFIG.nested_types_by_name['SessionkeyConfig']
...
_CONFIG_DEVICECONFIG_BUZZERMODE = _CONFIG_DEVICECONFIG.enum_types_by_name['BuzzerMode']
_CONFIG_POSITIONCONFIG_POSITIONFLAGS = _CONFIG_POSITIONCONFIG.enum_types_by_name['PositionFlags']
_CONFIG_POSITIONCONFIG_GPSMODE = _CONFIG_POSITIONCONFIG.enum_types_by_name['GpsMode']
_CONFIG_NETWORKCONFIG_ADDRESSMODE = _CONFIG_NETWORKCONFIG.enum_types_by_name['AddressMode']
_CONFIG_NETWORKCONFIG_PROTOCOLFLAGS = _CONFIG_NETWORKCONFIG.enum_types_by_name['ProtocolFlags']
_CONFIG_DISPLAYCONFIG_DEPRECATEDGPSCOORDINATEFORMAT = _CONFIG_DISPLAYCONFIG.enum_types_by_name['DeprecatedGpsCoordinateFormat']
...
_CONFIG_DISPLAYCONFIG_COMPASSORIENTATION = _CONFIG_DISPLAYCONFIG.enum_types_by_name['CompassOrientation']
...
Config = _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), {
  ...
  'DeviceConfig' : _reflection.GeneratedProtocolMessageType('DeviceConfig', (_message.Message,), {
    ...
    '__module__' : 'meshtastic.protobuf.config_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.DeviceConfig)
    })
  ,
  ...
  'PositionConfig' : _reflection.GeneratedProtocolMessageType('PositionConfig', (_message.Message,), {
    ...
    '__module__' : 'meshtastic.protobuf.config_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.PositionConfig)
    })
  ,
  ...
  'PowerConfig' : _reflection.GeneratedProtocolMessageType('PowerConfig', (_message.Message,), {
    ...
    '__module__' : 'meshtastic.protobuf.config_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.PowerConfig)
    })
  ,
  ...
  'NetworkConfig' : _reflection.GeneratedProtocolMessageType('NetworkConfig', (_message.Message,), {
    ...
    'IpV4Config' : _reflection.GeneratedProtocolMessageType('IpV4Config', (_message.Message,), {
      ...
      '__module__' : 'meshtastic.protobuf.config_pb2'
      # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.NetworkConfig.IpV4Config)
      })
    ,
    'DESCRIPTOR' : _CONFIG_NETWORKCONFIG,
    '__module__' : 'meshtastic.protobuf.config_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.NetworkConfig)
    })
  ,
  ...
  'DisplayConfig' : _reflection.GeneratedProtocolMessageType('DisplayConfig', (_message.Message,), {
    ...
    '__module__' : 'meshtastic.protobuf.config_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.DisplayConfig)
    })
  ,
  ...
  'LoRaConfig' : _reflection.GeneratedProtocolMessageType('LoRaConfig', (_message.Message,), {
    ...
    '__module__' : 'meshtastic.protobuf.config_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.LoRaConfig)
    })
  ,
  ...
  'BluetoothConfig' : _reflection.GeneratedProtocolMessageType('BluetoothConfig', (_message.Message,), {
    ...
    '__module__' : 'meshtastic.protobuf.config_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.BluetoothConfig)
    })
  ,

  'SecurityConfig' : _reflection.GeneratedProtocolMessageType('SecurityConfig', (_message.Message,), {
    'DESCRIPTOR' : _CONFIG_SECURITYCONFIG,
    '__module__' : 'meshtastic.protobuf.config_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.SecurityConfig)
    })
  ,

  'SessionkeyConfig' : _reflection.GeneratedProtocolMessageType('SessionkeyConfig', (_message.Message,), {
    'DESCRIPTOR' : _CONFIG_SESSIONKEYCONFIG,
    '__module__' : 'meshtastic.protobuf.config_pb2'
    # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config.SessionkeyConfig)
    })
  ,
  'DESCRIPTOR' : _CONFIG,
  '__module__' : 'meshtastic.protobuf.config_pb2'
  # @@protoc_insertion_point(class_scope:meshtastic.protobuf.Config)
  })
...
_sym_db.RegisterMessage(Config.SecurityConfig)
_sym_db.RegisterMessage(Config.SessionkeyConfig)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CONFIG._serialized_start=95
  _CONFIG._serialized_end=5592
  _CONFIG_DEVICECONFIG._serialized_start=724
  _CONFIG_DEVICECONFIG._serialized_end=1637
  _CONFIG_DEVICECONFIG_ROLE._serialized_start=1201
  _CONFIG_DEVICECONFIG_ROLE._serialized_end=1413
  _CONFIG_DEVICECONFIG_REBROADCASTMODE._serialized_start=1415
  _CONFIG_DEVICECONFIG_REBROADCASTMODE._serialized_end=1530
  _CONFIG_DEVICECONFIG_BUZZERMODE._serialized_start=1532
  _CONFIG_DEVICECONFIG_BUZZERMODE._serialized_end=1637
  _CONFIG_POSITIONCONFIG._serialized_start=1640
  _CONFIG_POSITIONCONFIG._serialized_end=2306
  _CONFIG_POSITIONCONFIG_POSITIONFLAGS._serialized_start=2080
  _CONFIG_POSITIONCONFIG_POSITIONFLAGS._serialized_end=2251
  _CONFIG_POSITIONCONFIG_GPSMODE._serialized_start=2253
  _CONFIG_POSITIONCONFIG_GPSMODE._serialized_end=2306
  _CONFIG_POWERCONFIG._serialized_start=2309
  _CONFIG_POWERCONFIG._serialized_end=2569
  _CONFIG_NETWORKCONFIG._serialized_start=2572
  _CONFIG_NETWORKCONFIG._serialized_end=3075
  _CONFIG_NETWORKCONFIG_IPV4CONFIG._serialized_start=2914
  _CONFIG_NETWORKCONFIG_IPV4CONFIG._serialized_end=2984
  _CONFIG_NETWORKCONFIG_ADDRESSMODE._serialized_start=2986
  _CONFIG_NETWORKCONFIG_ADDRESSMODE._serialized_end=3021
  _CONFIG_NETWORKCONFIG_PROTOCOLFLAGS._serialized_start=3023
  _CONFIG_NETWORKCONFIG_PROTOCOLFLAGS._serialized_end=3075
  _CONFIG_DISPLAYCONFIG._serialized_start=3078
  _CONFIG_DISPLAYCONFIG._serialized_end=4156
  _CONFIG_DISPLAYCONFIG_DEPRECATEDGPSCOORDINATEFORMAT._serialized_start=3711
  _CONFIG_DISPLAYCONFIG_DEPRECATEDGPSCOORDINATEFORMAT._serialized_end=3754
  _CONFIG_DISPLAYCONFIG_DISPLAYUNITS._serialized_start=3756
  _CONFIG_DISPLAYCONFIG_DISPLAYUNITS._serialized_end=3796
  _CONFIG_DISPLAYCONFIG_OLEDTYPE._serialized_start=3798
  _CONFIG_DISPLAYCONFIG_OLEDTYPE._serialized_end=3900
  _CONFIG_DISPLAYCONFIG_DISPLAYMODE._serialized_start=3902
  _CONFIG_DISPLAYCONFIG_DISPLAYMODE._serialized_end=3967
  _CONFIG_DISPLAYCONFIG_COMPASSORIENTATION._serialized_start=3970
  _CONFIG_DISPLAYCONFIG_COMPASSORIENTATION._serialized_end=4156
  _CONFIG_LORACONFIG._serialized_start=4159
  _CONFIG_LORACONFIG._serialized_end=5183
  _CONFIG_LORACONFIG_REGIONCODE._serialized_start=4689
  _CONFIG_LORACONFIG_REGIONCODE._serialized_end=4991
  _CONFIG_LORACONFIG_MODEMPRESET._serialized_start=4994
  _CONFIG_LORACONFIG_MODEMPRESET._serialized_end=5183
  _CONFIG_BLUETOOTHCONFIG._serialized_start=5186
  _CONFIG_BLUETOOTHCONFIG._serialized_end=5368
  _CONFIG_BLUETOOTHCONFIG_PAIRINGMODE._serialized_start=5312
  _CONFIG_BLUETOOTHCONFIG_PAIRINGMODE._serialized_end=5368
  _CONFIG_SECURITYCONFIG._serialized_start=5371
  _CONFIG_SECURITYCONFIG._serialized_end=5553
  _CONFIG_SESSIONKEYCONFIG._serialized_start=5555
  _CONFIG_SESSIONKEYCONFIG._serialized_end=5573
